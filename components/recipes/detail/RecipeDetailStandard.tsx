...
/**
 * Default recipe detail layout: a single narrow column with the title, a row of
 * stat chips, the cover image, description, then a two-column ingredients /
 * instructions grid and the notes box. This is the original (and fallback)
 * presentation — visually identical to the pre-variant detail page.
 */
export default function RecipeDetailStandard({ recipe }: { recipe: Recipe }) {
