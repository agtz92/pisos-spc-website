...
/**
 * Default blog post detail layout: constrained article header, full-width hero
 * image, narrow reading-width body. This is the original (and fallback)
 * presentation — visually identical to the pre-variant detail page.
 */
export default function BlogDetailStandard({ post }: { post: Post }) {
